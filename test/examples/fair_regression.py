...
class TestFairRegression(TestExamples):
    RESULTS: Dict[str, Dict[str, float]] = {
        'pretraining-mae': {
            'train-r2': 0.6672353190284235,
            'train-mse': 107593.96084721736,
            'train-didi': 0.20000363559036277,
            'test-r2': 0.6789768009383581,
            'test-mse': 103516.5196809794,
            'test-didi': 0.10413275407545175
        },
        'pretraining-mse': {
            'train-r2': 0.6673377143367666,
            'train-mse': 107560.85301628818,
            'train-didi': 0.20042226004852792,
            'test-r2': 0.6789615681097666,
            'test-mse': 103521.43162941586,
            'test-didi': 0.10499622069848828
        },
        'projection-mae': {
            'train-r2': 0.6672508880503402,
            'train-mse': 107588.92686124974,
            'train-didi': 0.20000957104672837,
            'test-r2': 0.678949000809302,
            'test-mse': 103525.48405680954,
            'test-didi': 0.1042080601192551
        },
        'projection-mse': {
            'train-mse': 107561.37671715903,
            'train-didi': 0.20040137356685922,
            'test-r2': 0.6789624120210789,
            'test-mse': 103521.1595034068,
            'test-didi': 0.10494881034643971
        }
    }
